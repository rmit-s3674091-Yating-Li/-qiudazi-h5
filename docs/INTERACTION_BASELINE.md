...
## 8. 设置与隐私
登录前必须可以直接访问《球搭子隐私政策（测试版）》，不得要求先登录。登录后的“设置与隐私”是个人偏好页，与登录前隐私政策分离。登录后的“我的”页必须直接提供“隐私政策”入口，“设置与隐私”页内也应再次提供政策入口；两处统一指向同一份公开政策正文，不能只依赖登录页才能找到政策。已登录二级页在无底部主导航时应有稳定返回路径，并提供回到赛事大厅的主页入口；登录前隐私政策和首次建档不暴露已登录主页入口。
