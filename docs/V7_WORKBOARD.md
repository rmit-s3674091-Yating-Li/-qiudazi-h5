...
| V7-REPO-01C | Repo remaining dead/legacy artifact cleanup | P2 | TODO | 除已审计 restore bundle 与 layered CSS 外，历史 QA/workflow、`source.bundle.b64` 等其他候选尚未逐项证明无运行/构建/测试/release/审计追溯依赖 | Builder 后续逐项审计；不能证明则继续标 `LEGACY_REVIEW`，不得盲删 |
