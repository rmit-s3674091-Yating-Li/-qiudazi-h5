...
| V7-REPO-01E | Repo remaining dead/legacy artifact cleanup | P2 | TODO | restore bundle、layered CSS、`source.bundle.b64` 与 AUD-015 specialist QA pair 已分别审计；其他历史 QA/workflow 等候选仍未逐项证明无运行/构建/测试/release/审计追溯依赖 | Builder 后续逐项审计；不能证明则继续标 `LEGACY_REVIEW`，不得盲删 |
