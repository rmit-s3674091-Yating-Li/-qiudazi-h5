...
export interface MapProvider{getCurrentPosition():Promise<VenueCoordinates>;externalMapUrl(location:{latitude:number;longitude:number;name?:string|null}):string}
