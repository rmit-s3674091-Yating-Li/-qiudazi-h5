...
import { Hall, PlayersPage, PlayerForm, ProfilePage, PrivacyPage, EventForm } from "./pages/Basics";
...
function App() {
  ...
  return <div className={"app-shell " + (tab ? "with-nav" : "")}>
    <Routes>
      ...
      <Route path="/players" element={<IdentityGate><PlayersPage /></IdentityGate>} />
