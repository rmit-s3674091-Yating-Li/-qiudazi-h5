...
begin
  ...
  if me is null
     or (e.owner_user_id is distinct from me
         and not public.is_actual_event_participant(p_event_id, me)) then
...
revoke all on function public.list_event_photos(uuid) from public, anon;
