create or replace function public.clear_invalid_partner_invites()
returns jsonb
language plpgsql
security definer
...
revoke all on function public.clear_invalid_partner_invites() from public, anon;
grant execute on function public.clear_invalid_partner_invites() to authenticated;
